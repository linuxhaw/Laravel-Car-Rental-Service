    ...
    <div class="animated fadeIn"><!-- div class=FadeIn start -->
        <div class="card"><!-- card start -->
            ...
            <div class="card-body">  <!-- card-body start -->
                ...
                <form action="/backend/car/update/{{ $car-> car_id}}" enctype="multipart/form-data" method="post">
...
<div class="col-md-4">
    Status<br>
    <select class="form-control" name="status" id="status"  value="{{ $car->status }}" required>
    ...
    <br>
                ...
                <div class="row"><!-- div class=row One start -->
                    ...
                    <div class="col-md-2">
                        <a href="/backend/dashboard" class="form-control btn btn-primary">Cancel</a>
                    </div>
