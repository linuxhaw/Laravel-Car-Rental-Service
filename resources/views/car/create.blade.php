...
<div class="col-md-4">
    ...
    <br>
                ...
                <div class="row"><!-- div class=row One start -->
                    ...
                    <div class="col-md-2">
                        <input class="form-control shadow-primary btn btn-default" type='submit' value="Save" style="background: -webkit-linear-gradient(#184652,rgb(13, 42, 43)); color:floralwhite;border-color:floralwhite"/>
                    </div>

                    <div class="col-md-2">
                        <a href="/dashboard" class="form-control shadow-primary btn btn-default" style="background: -webkit-linear-gradient(#184652,rgb(13, 42, 43)); color:floralwhite">Cancel</a>
                    </div>
